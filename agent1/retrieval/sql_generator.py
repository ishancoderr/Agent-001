...
log = logging.getLogger("agent1.retrieval.sql_generator")
...
class SqlGenerator:
    ...
    # geometry. Used by agent1/retrieval/geometry_resolver.py, whichever
    ...
    # agent1/pipeline/spatial_validator.py's verdict-style relationship
