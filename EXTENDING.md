...
`config/prompts/*.yaml`, not hand-written as a Python string. `agent1/pipeline/prompt_loader.py`
...
`agent1.pipeline.prompt_loader` directly:

```python
from agent1.pipeline.prompt_loader import EXTRACT_TEMPLATES, CLASSIFY_SYSTEM
